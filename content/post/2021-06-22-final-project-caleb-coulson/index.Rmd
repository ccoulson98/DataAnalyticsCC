...
sharks_data %>%
  ...
  slice(1:10)
```
## The previous list shows the top 10 most common countries where shark attacks occur. The following interactive chart allows you to see the distribution of types of attcacks in each of these 10 cntries
